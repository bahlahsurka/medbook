export const SYSTEMS = [
  ...
  'Musculoskeletal','Dermatology','Ophthalmology','ENT',
  'Reproductive (Male & Female)','Rheumatology',
  'Pharmacology','Biostatistics & Epidemiology','Ethics & Law',
...
export const SYS_COLOR = {
  ...
  'ENT':'#065f46','Reproductive (Male & Female)':'#8e44ad','Rheumatology':'#9f1239',
...
export const DIFF_COLOR = {
  Easy:'#16a34a', Medium:'#d97706', Hard:'#dc2626', Flagged:'#7c3aed'
};
